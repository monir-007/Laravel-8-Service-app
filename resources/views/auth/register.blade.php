                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input name="name" :value="old('name')" type="text" class="form-control input-lg" aria-describedby="nameHelp" placeholder="Name">
                            </div>
                            <div class="form-group col-md-12 mb-4">
                                <input name="email" :value="old('email')" type="email" class="form-control input-lg" aria-describedby="emailHelp" placeholder="Email">
                            </div>
