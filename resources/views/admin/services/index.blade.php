            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-between">
                        <h4 class="text-dark">Home Services</h4>

                        <button class="btn btn-info float-right mb-2" data-toggle="modal"
                                data-target="#exampleModalForm">
                            <span class="mdi mdi-plus-box-outline "></span> Add Services
                        </button>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalFormTitle">Add New Services</h5>
